...
public class DialogueContainer : SerializedMonoBehaviour
{
    ...
    public void AbortDialogue()
    {
        ...
        UI_LargeDialogue LdialogueUI = GameObject.FindObjectOfType<UI_LargeDialogue>();
        if (LdialogueUI == null) { Debug.LogError("UI_LargeDialogue를 포함하는 게임오브젝트를 찾을 수 없습니다. 해당 스크립트를 가진 오브젝트와 함께 사용해 주세요."); return; }

        dialogueUI.AbortDialogue();
        LdialogueUI.AbortDialogue();
